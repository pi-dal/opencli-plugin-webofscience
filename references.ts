...
cli({
  ...
  func: async (page, kwargs) => {
    ...
    // Step 2: Navigate to cited references summary page
    await page.goto(citedReferencesSummaryUrl(database, ut), { settleMs: 8000 });
    await page.wait(5);

    // Step 3: Scrape references from DOM
    ...
    // Step 4: Fallback — API from within browser context
